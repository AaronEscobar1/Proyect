...
describe('ModalAddEditComponent', () => {
  ...
  const URL = `${environment.api}/competencias`;
  ...
  it('Inicializar el componente Forma de Editar', () => {
    ...
    app.competencias = [
      {  
        ...
        "links": [
          {
            "rel": "nivelescompetencias",
            "href": "/configuraciones/configuraciones/talentos/nivelescompetencias/1"
          }
        ]
      },
      {
        ...
        "links": [
          {
            "rel": "nivelescompetencias",
            "href": "/configuraciones/configuraciones/talentos/nivelescompetencias/46"
          }
        ]
      }
    ];
