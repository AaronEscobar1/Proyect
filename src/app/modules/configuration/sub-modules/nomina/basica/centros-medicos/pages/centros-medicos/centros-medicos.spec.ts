...
describe('ClasificacionOficialComponent', () => {
  ...
  beforeEach( waitForAsync  (() => {
    ...
    services = TestBed.inject(CentrosMedicosService);

  }));

  it('Crear componente de Clasificacion Oficial correctamente', () => {
    const fixture = TestBed.createComponent(CentrosMedicosComponent);
  ...
  it('Inicializar el componente', async () => {
    const fixture = TestBed.createComponent(CentrosMedicosComponent);
    const app = fixture.componentInstance;
    expect(app.centrosMedicos.length).toBe(0);
    app.loadData();
    fixture.detectChanges();
    expect(app.centrosMedicos.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('Abrir modal de Crear Nivel', async () => {
    ...
    app.openModalCreate();
    fixture.detectChanges();
    expect(app.titleForm).toBe('Agregar centro médico');
  ...
  it('Abrir modal de Editar Nivel', async () => {
    ...
    expect(app.centrosMedicosSelect).toBe(undefined);
    app.editRow(data);
    fixture.detectChanges();
    expect(app.centrosMedicosSelect).toBe(data);
    expect(app.isEdit).toBeTrue();
    expect(app.titleForm).toBe('Editar centro médico');
    expect(app.createModal).toBeTrue();  
  })
  ...
  it('Eliminar Niveles Educativos (caso verdadero)', ()=>{
    ...
    const fakeBackend = httpTestingController.match(`${URL}/${data.codmed}`);
