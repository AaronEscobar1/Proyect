...
import { DataTableInstitucionesComponent } from './data-table-instituciones.component';
...
describe('DataTableComponent', () => {
  ...
  it('Crear componente de Niveles Educativos DataTable Component correctamente', () => {
    const fixture = TestBed.createComponent(DataTableInstitucionesComponent);
  ...
  it('Obtener Row Seleccionada ', () => {
    ...
    spyOn(service.selectRowInstitucion$, 'emit').and.callThrough();
    ...
    app.onRowSelect(log)
    expect(service.selectRowInstitucion$.emit).not.toHaveBeenCalledWith(null);
  ...
  it('Obtener Row Deseleccionada ', () => {
    ...
    app.onRowUnselect()
    expect(service.selectRowInstitucion$.emit).toHaveBeenCalledWith(null);
