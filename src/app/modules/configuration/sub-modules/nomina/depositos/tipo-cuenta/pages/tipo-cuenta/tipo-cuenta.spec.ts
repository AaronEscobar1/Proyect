...
describe('TipoCuentaComponent', () => {
  ...
  let services: TipoCuentaService;
  ...
  beforeEach( waitForAsync  (() => {
    ...
    services = TestBed.inject(TipoCuentaService);

  }));

  it('Crear componente de Clasificacion Oficial correctamente', () => {
    const fixture = TestBed.createComponent(TipoCuentaComponent);
  ...
  it('Inicializar el componente', async () => {
    const fixture = TestBed.createComponent(TipoCuentaComponent);
    const app = fixture.componentInstance;
    expect(app.tiposCuentas.length).toBe(0);
    app.loadData();
    fixture.detectChanges();
    expect(app.tiposCuentas.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('Abrir modal de Crear Nivel', async () => {
    ...
    app.openModalCreate();
    fixture.detectChanges();
    expect(app.titleForm).toBe('Agregar tipo de cuenta');
  ...
  it('Abrir modal de Editar Nivel', async () => {
    ...
    expect(app.tipoCuentaSelect).toBe(undefined);
    app.editRow(data);
    fixture.detectChanges();
    expect(app.tipoCuentaSelect).toBe(data);
  ...
  it('Eliminar Niveles Educativos (caso verdadero)', ()=>{
    ...
    const fakeBackend = httpTestingController.match(`${URL}/${data.tipcta}`);
