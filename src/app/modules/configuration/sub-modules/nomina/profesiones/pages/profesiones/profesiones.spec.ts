...
describe('ClasificacionOficialComponent', () => {
  ...
  let services: ProfesionesService;

  const URL = `${environment.api}/profesiones`;
  ...
  beforeEach( waitForAsync  (() => {
    ...
    services = TestBed.inject(ProfesionesService);

  }));

  it('Crear componente de Clasificacion Oficial correctamente', () => {
    const fixture = TestBed.createComponent(ProfesionesComponent);
  ...
  it('Inicializar el componente', async () => {
    const fixture = TestBed.createComponent(ProfesionesComponent);
    const app = fixture.componentInstance;
    expect(app.professions.length).toBe(0);
    app.loadData();
    fixture.detectChanges();
    expect(app.professions.length).toBeGreaterThanOrEqual(0);
  });
  ...
  it('Abrir modal de Editar Nivel', async () => {
    ...
    expect(app.professionSelect).toBe(undefined);
    app.editRow(data);
    fixture.detectChanges();
  ...
  it('Eliminar Niveles Educativos (caso verdadero)', ()=>{
    ...
    const fakeBackend = httpTestingController.match(`${URL}/${data.codprf}`);
