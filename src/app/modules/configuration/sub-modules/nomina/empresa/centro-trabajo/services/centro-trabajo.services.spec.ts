...
describe('NivelesEducativosServices', () => {
  ...
  let clasificacionesoficiales   : CentroTrabajoService;
  ...
  beforeEach( () => {
    ...
    clasificacionesoficiales = TestBed.inject(CentroTrabajoService);
  ...
  it('Deberia retornar Nivel Educativo (Id Existente)', waitForAsync( (done: DoneFn) => {
    ...
    clasificacionesoficiales.getAllCentrosTrabajosByEmpresa(id)
      .subscribe((resp) => {
        expect(resp).toEqual(mockResult);
        done();
      });
  ...
  it('actualizar nivel educativo (Caso exitoso)', waitForAsync ((done: DoneFn) => {
    ...
    clasificacionesoficiales.getCentroTrabajoByEmpresa("93", query)
      .subscribe((resp) => {
        expect(resp).toEqual(mockResult);
        done();
      });
