...
describe('NivelesEducativosServices', () => {
  ...
  let nivelesEducativosService   : GrupoTrabajoService;
  ...
  beforeEach( () => {
    ...
    nivelesEducativosService = TestBed.inject(GrupoTrabajoService);
  ...
  it('Deberia retornar arreglo de Niveles Educativos', waitForAsync ((done: DoneFn) => {
    ...
    nivelesEducativosService.getAllGruposByEmpresaNomina("93", "0001")
      .subscribe((resp) => {
        console.log(resp);
  ...
  it('Deberia retornar mensaje de error: 404 (Id inexistente)', waitForAsync( (done: DoneFn) => {
    ...
    nivelesEducativosService.getGrupoById("93", "0001", "01")
      .subscribe((resp) => {
      }, (error) => {
