...
describe('NivelesEducativosComponent', () => {
  ...
  let services: ConceptoSituacionService;
  ...
  beforeEach( waitForAsync  (() => {
    ...
    services = TestBed.inject(ConceptoSituacionService);

  }));

  it('Crear componente de Niveles Educativos correctamente', () => {
    const fixture = TestBed.createComponent(ModalConceptosComponent);
  ...
  it('Inicializar el componente', async () => {
    const fixture = TestBed.createComponent(ModalConceptosComponent);
    const app = fixture.componentInstance;
    expect(app.conceptoSituacion.length).toBe(0);
  ...
  it('Cargar Conceptos (caso fallido)', ()=>{
    ...
    app.loadConceptosSituacion(data);
    fixture.detectChanges(); 
    
    const fakeBackend = httpTestingController.expectOne(`${environment.api}/configuraciones/nominas/empresas/93/nominas/0001/situaciones/PPAR/conceptos`); 
  ...
  it('Cargar Conceptos (caso verdadero)', ()=>{
    ...
    const fakeBackend = httpTestingController.match(`${environment.api}/configuraciones/nominas/empresas/93/nominas/0001/situaciones/PPAR/conceptos`);
