...
import { ConceptoSituacionService } from './concepto-situacion.service';

describe('NivelesEducativosServices', () => {

  let nivelesEducativosService   : ConceptoSituacionService;
  ...
  beforeEach( () => {
    TestBed.configureTestingModule({
      ...
      declarations: [],
      providers: [ ConceptoSituacionService ]
    });

    nivelesEducativosService = TestBed.inject(ConceptoSituacionService);
  ...
  it('Deberia retornar arreglo de Niveles Educativos', waitForAsync ((done: DoneFn) => {
    ...
    nivelesEducativosService.getConceptoSituacion(situacion, concepto)
      .subscribe((resp) => {
        console.log(resp);
  ...
  it('Deberia retornar Nivel Educativo (Id Existente)', waitForAsync( (done: DoneFn) => {
    ...
    nivelesEducativosService.getAllConceptosSituacion(situacion)
      .subscribe((resp) => {
        expect(resp).toEqual(mockResult);
        done();
      });
  ...
  it('Deberia retornar mensaje de error: 404 (Id inexistente)', waitForAsync( (done: DoneFn) => {
    ...
    nivelesEducativosService.create(concepto, conceptoCreate)
      .subscribe((resp) => {
      }, (error) => {
  ...
  it('Deberia retornar mensaje de error: 404 (Id inexistente)', waitForAsync( (done: DoneFn) => {
    ...
    nivelesEducativosService.update(concepto, conceptoCreate)
      .subscribe((resp) => {
      }, (error) => {
        expect(error.status).toEqual(500);
        done();
  ...
  it('Deberia retornar mensaje de error: 404 (Id inexistente)', waitForAsync( (done: DoneFn) => {
    ...
    nivelesEducativosService.delete(concepto)
      .subscribe((resp) => {
      }, (error) => {
        expect(error.status).toEqual(500);
        done();
