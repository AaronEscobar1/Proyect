...
describe('NivelesEducativosServices', () => {
  ...
  let sindicatosService   : EstadoCivilService;
  ...
  beforeEach( () => {
    ...
    sindicatosService = TestBed.inject(EstadoCivilService);
  ...
  it('Debe crearse el servicio correctamente', () => {
    expect(EstadoCivilService).toBeTruthy();
  });
